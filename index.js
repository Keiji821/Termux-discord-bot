...
console.log(`${colors.fg.green}${decorations.bold}El bot ${client.user.tag} se ha conectado correctamente! [OK]${colors.reset}`);
};
...
console.log('[36m ﹂⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎭[0m');
rl.setPrompt(`>>> `); // Establecer el texto de la casilla "Opción: "
